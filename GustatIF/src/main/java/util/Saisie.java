...
public class Saisie {
    ...
    public static Long lireLong(String invite)
    {
        ...
        while (valeurLue == null) {
            try {
                valeurLue = Long.parseLong(lireChaine(invite));
            } catch (NumberFormatException ex) {
                System.out.println("/!\\ Erreur de saisie - Nombre entier attendu /!\\");
            }
        }
    ...
    // permet de faire une pause dans l'exécution du main, entrez une lettre 
    // pour reprendre le cours de l'exécution
    ...
    /*public static void main(String[] args) {
        ...
        Long nbPref = Saisie.lireLong("Entrez votre nom préféré: ");
        System.out.println(nbPref);
